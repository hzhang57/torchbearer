...
class GANModel(nn.Module):
    ...
    def forward(self, imgs_lr, state):
        # Forward
        state['gen_hr'] = self.generator(imgs_lr)
        state['gen_validity'] = self.discriminator(state['gen_hr'])
        # Forward
        state['desc_imgs_hr'] = self.discriminator(state['y_true'])
        state['desc_gen_hr'] = self.discriminator(state['gen_hr'].detach())
